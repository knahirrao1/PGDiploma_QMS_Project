        ...
        <div className="row gx-lg-5 align-items-center mb-5">
          <div className="col-lg-6 mb-5 mb-lg-0" style={{ zIndex: 10 }}>
            <h1 className="my-5 display-5 fw-bold ls-tight" style={{ color: 'hsl(218, 81%, 95%)' }}>
              ...
              <span style={{ color: ' hsl(218, 81%, 90%)' }}>Now you can join us as a creator!</span>
            </h1>
            <p className="mb-4 opacity-70" style={{ color: 'hsl(218, 81%, 85%)' }}>
              Creators can generate modules, create custom quizzes, and much more...Please consider joining us as creator, if you want to administer wonderful quizzes.
            </p>
          </div>
              ...
              <div className="card-body px-4 py-5 px-md-5">
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="form-outline mb-4">
                    ...
                    <label className="form-label" htmlFor="repass">Re-enter password</label>
                  </div>
   
                  <div className="form-check d-flex justify-content-center mb-4">
                    <input className="form-check-input me-2" type="checkbox" id="userType"
                    checked={isChecked}
